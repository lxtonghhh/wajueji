...
def start(is_test=False, is_all=False, params=PARAMS_10_day_by_15m, is_save=False):
    # 所有股票 15分钟10天tick 存入数据库中
    scan_tick_data(output=None, is_test=is_test, is_all=is_all, params=params, is_save=is_save)
